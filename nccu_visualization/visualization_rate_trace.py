...
def main():
    ...
    file_arr = ['rate-trace_5kbuk_half.txt', 'rate-trace_origin_10kbuk_newData.txt', 'nccu_output_noNDN.json']
    lable_arr = ["NDN hop by hop", "Kademlia", "kademlia hop by hop"]
    color_arr = ['r', 'g', 'b']
    ...
    for index in range(0,2):
        ...
        plt.plot(time_arr,PacketRaw_arr,'s-',color = color_arr[index], label=lable_arr[index])
    ...
    plt.ylabel("Physical income", fontsize=30, labelpad = 20)
